...
export default function FloatingWhatsApp() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 group flex items-center gap-4">
      <div className="bg-white dark:bg-[#2A2A2A] px-4 py-2 rounded-2xl shadow-xl border border-black/5 dark:border-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
        <p className="text-sm font-bold">
          <span>{t('wa_popup_1')}</span>{' '}
          <span className="text-blue-300">{t('wa_popup_2')}</span>
        </p>
      </div>
